              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-2 text-right">
                    <a
                      href="#"
                      className="text-sm text-gray-500 hover:text-[#30B8DE]"
                    >
                      Forgot password?
                    </a>
                  </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-[#30B8DE] hover:bg-[#29A3C8] text-white py-3 rounded-full font-medium transition-colors"
                >
                  Login
                </button>
              </form>
