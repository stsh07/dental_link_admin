// src/popups/addedsuccessfully.tsx
type DoctorAddedSuccessProps = {
    open: boolean;
    onClose: () => void;
  };
  
  export default function AddedSuccessfully({ open, onClose }: DoctorAddedSuccessProps) {
    if (!open) return null;
          ...
          <div className="flex flex-col items-center text-center space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-black text-[13px] leading-relaxed max-w-[377px] mx-auto">
                The new doctor's information has been saved successfully.
                You can now view the record in the doctor list.
              </p>
            </div>
